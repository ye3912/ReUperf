@echo off
REM 正常编译脚本 for thread_scheduler (Windows 版本)
REM 使用方法：build.bat

setlocal enabledelayedexpansion

echo ==========================================
echo Thread Scheduler - Normal Build (Windows)
echo ==========================================
...
dir "%BUILD_DIR%\" /s /b *.exe | findstr thread_scheduler.exe || dir "%BUILD_DIR%\" /b
